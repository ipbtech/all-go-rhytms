namespace AllGoRhytms.Searching
{
    public class BinarySearching
    {
        ...
        [Theory]
        [InlineData(3, 0, new int[] { 3, 4, 5, 7, 10, 21, 23, 26, 29, 31, 54, 58, 75, 80, 101, 156, 179 })]
        [InlineData(179, 16, new int[] { 3, 4, 5, 7, 10, 21, 23, 26, 29, 31, 54, 58, 75, 80, 101, 156, 179 })]
        [InlineData(21, 5, new int[] { 3, 4, 5, 7, 10, 21, 23, 26, 29, 31, 54, 58, 75, 80, 101, 156, 179 })]
        [InlineData(58, 11, new int[] { 3, 4, 5, 7, 10, 21, 23, 26, 29, 31, 54, 58, 75, 80, 101, 156, 179 })]
        [InlineData(101, 14, new int[] { 3, 4, 5, 7, 10, 21, 23, 26, 29, 31, 54, 58, 75, 80, 101, 156, 179 })]
        [InlineData(5, 2, new int[] { 3, 4, 5, 7, 10, 21, 23, 26, 29, 31, 54, 58, 75, 80, 101, 156, 179 })]
        [InlineData(26, 7, new int[] { 3, 4, 5, 7, 10, 21, 23, 26, 29, 31, 54, 58, 75, 80, 101, 156, 179 })]
