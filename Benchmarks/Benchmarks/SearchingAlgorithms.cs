...
namespace Benchmarks
{
    ...
    public class SearchingAlgorithms
    {
        ...
        [Benchmark]
        public void JumpSearchLastIndex() => _jumpSearching.JumpSearchLastIndex(21, 5, _inputArray);

        [Benchmark]
        public void BinarySearchFirstIndex() => _binarySearching.BinarySearchFirstIndex(21, 5, _inputArray);

        [Benchmark]
        public void BinarySearchLastIndex() => _binarySearching.BinarySearchLastIndex(21, 5, _inputArray);
    }
}
